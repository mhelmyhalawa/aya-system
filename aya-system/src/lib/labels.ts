...
const ar = {
  ...
  teacherSessionsLabels: {
    ...
    futureSessionsForCircle: (circle: string) => `الجلسات القادمة لحلقة : ${circle}`,
    futureSessionsGeneric: 'اختر الحلقة لعرض الجلسات القادمة',
    addSessionButton: 'تسجيل جلسة جديدة',
    totalFutureSessions: (count: number) => `عدد الجلسات القادمة: ${count}`,
    noFutureSessions: 'لا توجد جلسات مستقبلية',
    chooseCircleTitle: 'اختر حلقة لعرض الجلسات',
    chooseCircleHelp: 'يرجى اختيار حلقة من القائمة على اليمين لعرض الجلسات القادمة الخاصة بها',
